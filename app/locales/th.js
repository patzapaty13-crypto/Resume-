export const th = {
  ...
  hero: {
    greeting: "สวัสดีครับ พวกเราคือ",
    role: "Full-Stack & AI Automation Team",
    contactMe: "ติดต่อเรา",
    viewWork: "ดูผลงานทีม",
    resume: "ดู Resume สมาชิก"
  },
  about: {
    title: "เกี่ยวกับทีมและประวัติสมาชิก",
    subtitle: "เลือกดู Resume และข้อมูลประวัติส่วนตัวของสมาชิกทั้ง 5 คน",
    bio: "พวกเราเป็นทีมพัฒนาซอฟต์แวร์ครบวงจร มีความเชี่ยวชาญในการพัฒนาเว็บแอปพลิเคชัน ระบบหลังบ้าน การออกแบบ UI/UX ระบบรักษาความปลอดภัยข้อมูล และการทำ AI Automation สำหรับองค์กร",
    educationTitle: "การศึกษา",
    educationDesc: "ปริญญาตรี คณะวิทยาศาสตร์และเทคโนโลยี สาขาวิทยาการคอมพิวเตอร์ มหาวิทยาลัยหอการค้าไทย (UTCC)"
  },
  team: {
    title: "ทีมงานของเรา",
    subtitle: "ทีมวิศวกรซอฟต์แวร์และนักออกแบบดิจิทัล พร้อมให้บริการพัฒนาซอฟต์แวร์ครบวงจร",
    viewDetails: "ดู Resume รายบุคคล",
    close: "ปิด",
    members: [
      {
        id: "wananon",
  ...
  skills: {
    title: "ทักษะและความเชี่ยวชาญของทีม",
    frontend: "Frontend Development",
    backend: "Backend & Cybersecurity",
    database: "Database & Cloud Infrastructure",
    tools: "Tools & AI Automation"
  },
  projects: {
    title: "ผลงานพัฒนาซอฟต์แวร์ของทีม",
    subtitle: "โปรเจกต์และแอปพลิเคชันที่พัฒนาขึ้นโดยการทำงานร่วมกันของสมาชิกในทีม",
    details: "ดูรายละเอียดโปรเจกต์",
    teamMembers: "ผู้พัฒนาในโครงการ:",
    overview: "ภาพรวมโปรเจกต์ (Overview)",
    challenges: "ความท้าทาย & วิธีแก้ปัญหา (Challenges & Solutions)",
    liveDemo: "ดูเว็บไซต์จริง (Live Demo)",
    fastwork: "จ้างงานผ่าน Fastwork",
    github: "ดูโค้ดบน GitHub"
  },
  packages: {
    title: "แพ็กเกจและบริการพัฒนาซอฟต์แวร์",
    fastwork: "จ้างงานผ่าน Fastwork",
    contactDirect: "ปรึกษาเราฟรี",
    basic: {
      title: "Basic Website",
      price: "เริ่มต้น 5,000฿",
      desc: "เหมาะสำหรับเว็บโปรไฟล์ บริษัท หรือ Landing Page ประสิทธิภาพสูง",
      f1: "Responsive Design (รองรับการใช้งานบนมือถือ)",
      f2: "การปรับแต่ง SEO พื้นฐาน",
      f3: "พัฒนาด้วย Next.js / React",
      f4: "รวมบริการโฮสติ้ง 1 ปี"
    },
    pro: {
      title: "Web Application & Admin Portal",
      price: "เริ่มต้น 15,000฿",
      desc: "ระบบจัดการข้อมูล หลังบ้าน และฟีเจอร์การทำงานซับซ้อน",
      f1: "ระบบสมาชิกและการสิทธิ์ใช้งาน (Authentication & RBAC)",
      f2: "ระบบแดชบอร์ดจัดการข้อมูล",
      f3: "การออกแบบและเชื่อมต่อ API",
      f4: "ระบบฐานข้อมูล (PostgreSQL / MySQL)"
    },
    automation: {
      title: "AI & Workflow Automation",
      price: "เริ่มต้น 8,000฿",
      desc: "การเชื่อมต่อ API ข้ามแพลตฟอร์มและสร้างระบบทำงานอัตโนมัติ",
      f1: "วาง Workflow ระบบอัตโนมัติด้วย n8n / Make",
      f2: "เชื่อมต่อ LINE OA / Slack / Email",
      f3: "เชื่อมต่อกับ ChatGPT / AI APIs",
      f4: "ช่วยลดเวลาและขั้นตอนการทำงานที่ซ้ำซ้อน"
    }
  },
  contact: {
    title: "ติดต่อเรา",
    subtitle: "สนใจปรึกษาการพัฒนาซอฟต์แวร์ หรือต้องการสอบถามข้อมูลเพิ่มเติม ติดต่อพวกเราได้ทันที",
    fastwork: "จ้างงานผ่าน Fastwork (การันตีงาน)",
    github: "ดูโค้ดบน GitHub",
    linkedin: "โปรไฟล์ LinkedIn"
  },
  footer: {
    madeWith: "พัฒนาด้วย",
    by: "ทีม CR7XMESSI AND YAMAL CHAMPION",
