export const en = {
  ...
  hero: {
    ...
    resume: "View Team Resumes"
  },
  about: {
    title: "About Team & Member Profiles",
    subtitle: "Select and view dedicated resume profiles for all 5 team members",
    bio: "We are an end-to-end software development team specializing in web applications, backend engineering, UI/UX design, cybersecurity, data analytics, and AI workflow automation.",
    educationTitle: "Education",
    educationDesc: "Bachelor of Science in Computer Science, University of the Thai Chamber of Commerce (UTCC)"
  },
  team: {
    title: "Our Team",
    subtitle: "Software engineers and digital designers ready to deliver full-cycle software solutions",
    viewDetails: "View Full Resume Profile",
    close: "Close",
    members: [
      {
        id: "wananon",
  ...
  projects: {
    title: "Team Projects",
    subtitle: "Software solutions and web platforms built collaboratively by our team",
    details: "View Details",
    teamMembers: "Contributors:",
    overview: "Project Overview",
    challenges: "Challenges & Solutions",
    liveDemo: "Live Demo",
    fastwork: "Hire on Fastwork",
    github: "View on GitHub"
  },
  packages: {
    title: "Packages & Services",
    fastwork: "Hire on Fastwork",
    contactDirect: "Free Consultation",
    basic: {
      title: "Basic Website",
      price: "Starting at 5,000฿",
      desc: "High-performance company website, portfolio, or landing page",
      f1: "Responsive Design (Mobile-friendly)",
      f2: "Basic SEO Setup",
      f3: "Built with Next.js / React",
      f4: "Includes 1-Year Hosting"
    },
    pro: {
      title: "Web Application & Admin Portal",
      price: "Starting at 15,000฿",
      desc: "Complex data management portal with custom features",
      f1: "Authentication & Role-Based Access (RBAC)",
      f2: "Data Dashboard",
      f3: "API Integration",
      f4: "Database (PostgreSQL / MySQL)"
    },
    automation: {
      title: "AI & Workflow Automation",
      price: "Starting at 8,000฿",
      desc: "API integration and automated workflow infrastructure",
      f1: "Workflow automation design with n8n / Make",
      f2: "LINE OA / Slack / Email Integration",
      f3: "ChatGPT / AI API Integration",
      f4: "Save time on repetitive tasks"
    }
  },
  contact: {
    title: "Contact Us",
    subtitle: "Interested in working together or hiring our development team? Reach out to us.",
    fastwork: "Hire on Fastwork (Guaranteed)",
    github: "View on GitHub",
    linkedin: "LinkedIn Profile"
  },
  footer: {
    madeWith: "Built with",
    by: "CR7XMESSI AND YAMAL CHAMPION Team",
